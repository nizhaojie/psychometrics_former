...
import { getRecordByOrganization } from '@/api/record';
...
// 获取记录数据
const getRecordData = async (organization) => {
  let res = await getRecordByOrganization(organization)
...
getRecordData(userInfoStore?.info?.organization)
